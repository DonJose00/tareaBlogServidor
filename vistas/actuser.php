  ...
  <div class="centrar">
    <div class="container centrar">
      ...
      <div class="container cuerpo text-center centrar">
        <p>
        <h2>Actualizar entrada al Blog</h2>
        </p>
      </div>
      ...
      <div class="addEntradas">
        <form action="index.php?accion=actuser" method="post" enctype="multipart/form-data">
          ...
          <input class="form-control" type="text" id="titulo" name="titulo" value="<?= $parametros["datos"]["titulo"]?>"><br>

          <label for="imagen">Imagen:</label><br>
          <input class="form-control" type="file" id="imagen" name="imagen" value="<?= $parametros["datos"]["imagen"]?>"><br>

          <label for="descripcion">Descripción:</label><br>
          <textarea class="form-control" id="descripcion" name="descripcion" value="<?= $parametros["datos"]["descripcion"]?>"></textarea><br>

          <label for="fecha">Fecha:</label><br>
          <input type="date" id="fecha" name="fecha" value="<?= $parametros["datos"]["fecha"]?>"><br>
          <br>
